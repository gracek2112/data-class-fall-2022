...
total_opiods <- read_csv("arcos.csv")
total_county_pop14<- read_csv("county_population_2014.csv")
total_state_pop14 <- read_csv("state_population_2014.csv ")
State_abbrv<- read_csv("state_crosswalk.csv")

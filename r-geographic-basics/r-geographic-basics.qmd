...
# Spatial join in r is very helpful when it comes to geospatial operations. While they used it to join the datasets that included the income by census tracts and schools with low attendance, I do find there could have been chances where I could have used such as looking at a dataset with the percentage of families below the poverty line by the census and a data set that included families in Baltimore that use Snap benefits. Using a spatial join would add a column to allow us to see where these subjects in the data exist in Baltimore. I would need to include a neighborhood data frame of residents that includes zipcodes  We could also use a spatial join to observe datasets that look at the percentage of residents who own a home and the percentage of residents who have a college degree. Then we could see where these residents exist in  Baltimore whom both have a college degree and if they are homeowners to observe a correlation. The geographic data frames I would need include neighborhood data frames of residents that include locations of the residents with college degrees such as addresses. 

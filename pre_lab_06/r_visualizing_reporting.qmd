...
#we want to reorder the variables, if you put a - behind the n it sorts it in descdending order 
```{r}
years %>%
  ggplot() +
...
# ggplot(m_v_f, aes(disability_blah_blah, n, fill = one_)) +
#   geom_col(position = "dodge")
...
arrest %>%
  ...
  theme_economist() +
  labs(
    title="Total arrests by year",
    x = "year",
    y = "arrest",
    caption = "source: SF PD  Call Data between 2016-2019")
```

...
**Task**: What did you expect to happen? Describe here what happened when you made these changes. 
I expected the output would output would  not show up on render for the first task/codeb block and the output would be available or clear for second. But th eoutput did show up for the first code block and disapper on the second.  

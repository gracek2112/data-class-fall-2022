...
#Oftentimes, our data does not have an exact match and A spatial buffer as I learned in this lab allows a "buffer" the zone or area around a point that surrounded the area within the vicinity of the map features. Now that I am aware of the spatial buffer I could use it for how many liquor stores are near neighborhoods with a poverty rate above the average. Baltimore city. The data frame would include information regarding the neighborhoods with families below the poverty line in Baltimore city a data frame which includes liquor stores in a 10-mile radius. I could also use a spatial buffer to find how many clinics are near neighborhoods with high mortgage rates. This datafram would include neighborhoods with high mortgage rates and hospitals and addresses in a 15-mile radius.  
